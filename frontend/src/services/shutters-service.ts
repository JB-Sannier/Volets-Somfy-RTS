...
export async function listShutters(): Promise<IListShuttersResponse> {
  try {
...
export async function getShutter(
...
export async function addShutter(
...
export async function modifyShutter(
...
export async function deleteShutter(
